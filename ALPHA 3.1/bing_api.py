    ...
    def obter_imagem(self, idade, personagem):
        ...
        with requests.Session() as sessao_tcp:
            ...
            try:
                ...
                sg.popup(f"Erro na requisição para a API do Bing!\n\nErro: {erro}\n\nNão será possível baixar imagens dessa vez.", title="Falha na Chamada para a API do Bing")
                return
            ...
            for resultado in search_result["value"]:
                ...
                try:
                    ...
                    sg.popup(f"Erro na requisição para tentar baixar uma imagem!\n\n\nErro: {erro}", title="Falha no Download de Imagem")
                ...
                try:
                    ...
                    sg.popup(f"Erro ao lidar com uma imagem!\n\n\nErro: {erro}", title="Erro com a imagem")
                    continue
